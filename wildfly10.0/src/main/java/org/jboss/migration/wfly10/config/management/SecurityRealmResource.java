...
public interface SecurityRealmResource extends ManageableResource {
    ...
    interface Parent extends ManageableResource {
        ...
        default ModelNode getSecurityRealmResourceConfiguration(String resourceName) throws ManagementOperationException {
            return getChildResourceConfiguration(RESOURCE_TYPE, resourceName);
        }
        default boolean hasSecurityRealmResource(String resourceName) throws ManagementOperationException {
