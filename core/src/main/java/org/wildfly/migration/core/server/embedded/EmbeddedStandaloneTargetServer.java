...
import org.wildfly.migration.core.server.TargetServerManagement;
 ...
 * @author emmartins
 */
class EmbeddedStandaloneTargetServer implements TargetServer {

    private final String config;
    private final Path baseDir;
    private StandaloneServer standaloneServer;

    EmbeddedStandaloneTargetServer(String config, Path baseDir) {
        this.config = config;
