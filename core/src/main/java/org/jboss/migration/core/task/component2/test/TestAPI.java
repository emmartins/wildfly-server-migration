...
import org.jboss.migration.core.task.component2.CompositeTask.SubtasksBuilder;
...
public class TestAPI {
    ...
    static void test() throws Exception {
        ...
        cbX
                ...
                .beforeRun(br)
                .beforeRun(brX)
                .subtasks(new SubtasksBuilder<XTaskParams>()
                        .subtask(t)
                        .subtask(lb)
                        .subtask(lbX)
                        .subtask(cb)
        ...
        cbY
                ...
                .beforeRun(brY)
                .beforeRun(br)
                .subtasks(new SubtasksBuilder<YTaskParams>()
                        .subtask(pcYX, lbX)
                        .subtask(pcYY, lbY)
                        .subtask(pcYZ, lbZ)
                        .subtask(cbY.clone())
        ...
        cbZ
                ...
                .skipPolicy(spZ)
                .beforeRun(brZ)
                .subtasks(new SubtasksBuilder<ZTaskParams>()
                        .subtask(t)
                        .subtask(pcZX, lbX)
                        .subtask(pcZY, lbY)
                        .subtask(pcZZ, lbZ)
        ...
        cbXY
                ...
                .beforeRun(brY)
                .beforeRun(brXY)
                .subtasks(new SubtasksBuilder<XYTaskParams>()
                        .subtask(t)
                        .subtask(lb)
                        .subtask(lbX)
                        .subtask(lbY)
        ...
        cbXYZ
                ...
                .beforeRun(brXY)
                .beforeRun(brXYZ)
                .subtasks(new SubtasksBuilder<XYZTaskParams>()
                        .subtask(t)
                        .subtask(lb)
                        .subtask(lbX)
                        .subtask(lbY)
