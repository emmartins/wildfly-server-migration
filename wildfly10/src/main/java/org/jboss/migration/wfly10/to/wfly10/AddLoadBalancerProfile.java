...
public class AddLoadBalancerProfile<S> extends AddProfileTaskBuilder<S> {
    ...
    public AddLoadBalancerProfile() {
        ...
        subsystemSubtasks.subtask(new AddSubsystemConfigurations<S>(ExtensionNames.IO, new AddIOSubsystemConfig<>()));
        subsystemSubtasks.subtask(new AddSubsystemConfigurations<S>(ExtensionNames.UNDERTOW, new AddUndertowSubsystemConfig<>()));
        subsystemSubtasks.subtask(new AddSubsystemConfigurations<S>(ExtensionNames.LOGGING, new AddLoggingSubsystemConfig<>()));
    }
