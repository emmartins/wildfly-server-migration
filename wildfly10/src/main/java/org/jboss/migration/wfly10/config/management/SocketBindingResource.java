...
public interface SocketBindingResource extends ManageableResource {
    ...
    interface Parent extends ManageableResource {
        ...
        default ModelNode getSocketBindingResourceConfiguration(String resourceName) throws ManagementOperationException {
            return getChildResourceConfiguration(RESOURCE_TYPE, resourceName);
        }
        default boolean hasSocketBindingResource(String resourceName) throws ManagementOperationException {
