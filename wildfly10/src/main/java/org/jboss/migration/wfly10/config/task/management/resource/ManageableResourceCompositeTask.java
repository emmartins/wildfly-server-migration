...
public class ManageableResourceCompositeTask extends CompositeTask {
    ...
    public static class Builder<S, R extends ManageableResource> extends BaseBuilder<ManageableResourceBuildParameters<S, R>, Builder<S, R>> {
        ...
        protected <R1 extends ManageableResource> BuildParameters.Mapper<ManageableResourceBuildParameters<S, R>, ManageableResourcesBuildParameters<S, R1>> getResourcesMapper(ManageableResourceSelector<R1> resourceSelector) {
            return sourceParams -> {
                final Collection<? extends R1> resources = resourceSelector.fromResources(sourceParams.getResource());
        ...
        protected <R1 extends ManageableResource> BuildParameters.Mapper<ManageableResourceBuildParameters<S, R>, ManageableResourceBuildParameters<S, R1>> getResourceMapper(ManageableResourceSelector<R1> resourceSelector) {
            return sourceParams -> {
                final Collection<? extends R1> resources = resourceSelector.fromResources(sourceParams.getResource());
