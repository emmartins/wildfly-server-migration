 ...
 * @author emmartins
 */
public class RemovePermgenAttributesFromJVMs<S> extends ServerConfigurationCompositeTask.Builder<S> {

    public RemovePermgenAttributesFromJVMs() {
        ...
        subtasks(JvmResource.class, ResourceCompositeSubtasks.of(new Subtask<>()));
    }
