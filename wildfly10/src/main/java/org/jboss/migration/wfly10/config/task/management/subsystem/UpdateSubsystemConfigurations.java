 ...
 * @author emmartins
 */
public class UpdateSubsystemConfigurations<S> extends ManageableResourcesCompositeTask.Builder<S, ManageableResource> {

    public UpdateSubsystemConfigurations(String subsystemName, UpdateSubsystemConfigurationSubtaskBuilder<S>... subtasks) {
        ...
        final ManageableResourceCompositeSubtasks.Builder<S, SubsystemConfiguration> subtasksBuilder = new ManageableResourceCompositeSubtasks.Builder<>();
