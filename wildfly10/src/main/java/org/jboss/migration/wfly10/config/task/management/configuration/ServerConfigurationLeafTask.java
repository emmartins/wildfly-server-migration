 ...
 * @author emmartins
 */
public class ServerConfigurationLeafTask extends LeafTask {

    protected ServerConfigurationLeafTask(ServerMigrationTaskName name, TaskRunnable taskRunnable) {
    ...
    public static class Builder<S> extends BaseBuilder<ServerConfigurationBuildParameters<S>, Builder<S>> implements ServerConfigurationComponentTaskBuilder<S, Builder<S>> {
        ...
        protected ServerMigrationTask buildTask(ServerMigrationTaskName name, TaskRunnable taskRunnable) {
            return new ServerConfigurationLeafTask(name, taskRunnable);
        }
    }
}
