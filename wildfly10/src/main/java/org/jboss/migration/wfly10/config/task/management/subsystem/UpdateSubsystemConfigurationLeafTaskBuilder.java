 ...
 * @author emmartins
 */
public abstract class UpdateSubsystemConfigurationLeafTaskBuilder<S> extends SubsystemConfigurationLeafTaskBuilder<S> {

    protected UpdateSubsystemConfigurationLeafTaskBuilder() {
