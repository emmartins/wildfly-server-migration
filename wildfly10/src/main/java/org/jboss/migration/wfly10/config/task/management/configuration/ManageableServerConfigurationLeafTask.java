...
public class ManageableServerConfigurationLeafTask extends LeafTask {
    ...
    protected ManageableServerConfigurationLeafTask(ServerMigrationTaskName name, TaskRunnable taskRunnable) {
    ...
    public static class Builder<S> extends BaseBuilder<ManageableServerConfigurationParameters<S>, Builder<S>> {
        ...
        protected ServerMigrationTask buildTask(ServerMigrationTaskName name, TaskRunnable taskRunnable) {
            return new ManageableServerConfigurationLeafTask(name, taskRunnable);
        }
    }
}
