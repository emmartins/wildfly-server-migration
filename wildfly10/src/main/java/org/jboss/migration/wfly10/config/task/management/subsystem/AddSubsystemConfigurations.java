 ...
 * @author emmartins
 */
public class AddSubsystemConfigurations<S> extends ManageableResourcesCompositeTask.Builder<S, ManageableResource> {

    public AddSubsystemConfigurations(String extension, String subsystem) {
        this(extension, new AddSubsystemConfigurationSubtaskBuilder<>(subsystem));
    }

    public AddSubsystemConfigurations(final String extension, AddSubsystemConfigurationSubtaskBuilder<S> subtask) {
        ...
        subtasks(new ManageableResourceCompositeSubtasks.Builder<S, ManageableResource>()
                ...
                .subtask(SubsystemConfiguration.Parent.class, subtask));
        afterRun(context -> {
