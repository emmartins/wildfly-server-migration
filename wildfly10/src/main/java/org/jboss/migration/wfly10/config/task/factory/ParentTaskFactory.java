 ...
 * @author emmartins
 */
public class ParentTaskFactory<S, T> implements ManageableServerConfigurationTaskFactory<S, T> {
    ...
    protected ParentTaskFactory(Builder<S> builder) {
    ...
    public static class Builder<S> {
        ...
        public ParentTaskFactory<S> build() {
            return new ParentTaskFactory(this);
        }
    }
}
