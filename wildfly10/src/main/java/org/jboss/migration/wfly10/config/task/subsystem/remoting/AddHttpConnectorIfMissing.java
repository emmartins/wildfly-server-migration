 ...
 * @author emmartins
 */
public class AddHttpConnectorIfMissing<S> extends UpdateSubsystemConfigurationSubtaskBuilder<S> {
    ...
    protected ServerMigrationTaskResult updateConfiguration(ModelNode config, S source, SubsystemConfiguration subsystemConfiguration, TaskContext taskContext, TaskEnvironment taskEnvironment) {
        ...
        final ManageableServerConfiguration serverConfiguration = subsystemConfiguration.getServerConfiguration();
        // read env properties
