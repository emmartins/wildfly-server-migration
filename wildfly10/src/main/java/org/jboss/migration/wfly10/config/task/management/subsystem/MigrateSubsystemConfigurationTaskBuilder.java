 ...
 * @author emmartins
 */
public class MigrateSubsystemConfigurationTaskBuilder<S> extends ResourcesCompositeTask.Builder<S, ManageableResource> {

    public MigrateSubsystemConfigurationTaskBuilder(String extension, String subsystem) {
        this(extension, new MigrateSubsystemConfigurationSubtaskBuilder<>(subsystem));
    }

    public MigrateSubsystemConfigurationTaskBuilder(final String extensionModule, MigrateSubsystemConfigurationSubtaskBuilder<S> subtask) {
        ...
        subtasks(new ResourceCompositeSubtasks.Builder<S, ManageableResource>()
