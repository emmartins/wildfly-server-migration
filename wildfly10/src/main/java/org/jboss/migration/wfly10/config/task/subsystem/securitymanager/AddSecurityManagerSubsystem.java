 ...
 * @author emmartins
 */
public class AddSecurityManagerSubsystem<S> extends AddSubsystemConfigurations<S> {
    public AddSecurityManagerSubsystem() {
        super(ExtensionNames.SECURITY_MANAGER, new AddSecurityManagerSubsystemConfiguration<>());
    }
}
