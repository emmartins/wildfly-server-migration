...
public interface HostResource extends ManageableResource {
    ...
    ManageableResourceType RESOURCE_TYPE = new ManageableResourceType(HostResource.class);
    ...
    interface Parent extends ManageableResource {
        ...
        default ModelNode getHostResourceConfiguration(String resourceName) throws ManagementOperationException {
            return getChildResourceConfiguration(RESOURCE_TYPE, resourceName);
        }
        default boolean hasHostResource(String resourceName) throws ManagementOperationException {
