...
public class ProfileResourceImpl extends ManageableResourceImpl implements ProfileResource {
    ...
    public ProfileResourceImpl(String resourceName, PathAddress pathAddress, ManageableServerConfiguration serverConfiguration) {
        super(resourceName, pathAddress, serverConfiguration);
        subsystemResources = new SubsystemResourcesImpl(pathAddress, serverConfiguration);
