 ...
 * @author emmartins
 */
public class HostsManagementTask<S> extends ManageableResourceTask<S, HostsManagement> {
    ...
    public static class Builder<S> extends ManageableResourceTask.BaseBuilder<S, HostsManagement, Subtasks<S>, Builder<S>> {
