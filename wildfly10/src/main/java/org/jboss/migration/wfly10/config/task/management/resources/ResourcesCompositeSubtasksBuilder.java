 ...
 * @author emmartins
 */
public interface ResourcesCompositeSubtasksBuilder<S, R extends ManageableResource, T extends ResourcesCompositeSubtasksBuilder<S, R, T>> extends CompositeSubtasksBuilder<ResourcesBuildParameters<S, R>, T> {
