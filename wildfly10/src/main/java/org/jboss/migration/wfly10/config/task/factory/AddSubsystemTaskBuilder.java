...
public class AddSubsystemTaskBuilder<S> extends SubsystemConfigurationTaskBuilder<S> {
    ...
    private static class Subtasks<S> implements ParentTask.Subtasks<ResourceManagementTask.SubtasksContext<S, SubsystemsManagement>> {
        ...
        @Override
        public void run(ResourceManagementTask.SubtasksContext<S, SubsystemsManagement> context) throws Exception {
