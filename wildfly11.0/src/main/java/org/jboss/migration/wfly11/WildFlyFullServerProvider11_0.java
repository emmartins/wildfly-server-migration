...
/**
 * The WildFly 11.0 Full {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFlyFullServerProvider11_0 extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFlyFullServer11_0(migrationName, productInfo, baseDir, migrationEnvironment);
    }
