...
$TOOL_DIR/jboss-server-migration.sh --source $SOURCE_DIST_DIR --target $TARGET_DIST_DIR --interactive false -Djboss.server.migration.deployments.migrate-deployments.skip="false" -Djboss.server.migration.subsystem.logging.update.remove-console-handler.skip="false" -Djboss.server.migration.modules.includes="cmtool.module1" -Djboss.server.migration.modules.excludes="cmtool.module2,cmtool.module3"
