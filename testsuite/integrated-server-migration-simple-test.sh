...
$TOOL_DIR/../bin/jboss-server-migration.sh --source=$SOURCE_DIST_DIR --target=$TARGET_DIST_DIR --interactive=false -Djboss.server.migration.modules.includes="cmtool.module1" -Djboss.server.migration.modules.excludes="cmtool.module2,cmtool.module3"