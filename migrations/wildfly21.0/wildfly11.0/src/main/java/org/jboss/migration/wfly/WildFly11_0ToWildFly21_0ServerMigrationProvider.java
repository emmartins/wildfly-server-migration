...
import org.jboss.migration.wfly.task.hostexclude.WildFly21_0AddHostExcludes;
...
/**
 * Server migration to WFLY 21.0, from WFLY 11.0.
 * @author emmartins
 */
public class WildFly11_0ToWildFly21_0ServerMigrationProvider implements WildFly21_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly11_0ToWildFly21_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly21_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly21_0UpdateJGroupsSubsystem<>())
                ...
                .domain(serverUpdateBuilders.domainBuilder()
                        .domainConfigurations(serverUpdateBuilders.domainConfigurationBuilder()
                                ...
                                .subtask(new AddMicroprofileConfigSmallryeSubsystem<>())
                                .subtask(new AddMicroprofileOpentracingSmallryeSubsystem<>())
                                .subtask(new WildFly21_0AddHostExcludes<>())
