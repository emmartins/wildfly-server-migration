...
/**
 * Server migration to WFLY 21.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly21_0ServerMigrationProvider implements WildFly21_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly21_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly21_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly21_0UpdateJGroupsSubsystem<>())
