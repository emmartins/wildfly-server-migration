...
/**
 * Server migration to WFLY 21.0, from WFLY 21.0.
 * @author emmartins
 */
public class WildFly21_0ToWildFly21_0ServerMigrationProvider implements WildFly21_0ServerMigrationProvider {
