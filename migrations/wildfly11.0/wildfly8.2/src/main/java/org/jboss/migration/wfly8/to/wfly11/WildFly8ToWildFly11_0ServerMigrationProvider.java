...
/**
 * Server migration to WFLY 11.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly11_0ServerMigrationProvider implements WildFlyFullServerMigrationProvider11_0 {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly11_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly11_0UpdateUndertowSubsystem<>())
