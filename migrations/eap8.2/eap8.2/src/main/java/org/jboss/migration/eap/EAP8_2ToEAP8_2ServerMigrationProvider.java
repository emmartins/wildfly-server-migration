...
/**
 * Server migration, from EAP 8.2 to EAP 8.2.
 * @author abgopal
 */
public class EAP8_2ToEAP8_2ServerMigrationProvider implements EAPServerMigrationProvider8_2 {
    ...
    @Override
    public Class<EAPServer8_2> getSourceType() {
        return EAPServer8_2.class;
    }
}
