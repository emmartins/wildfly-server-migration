...
/**
 * Server migration, from EAP 7.1 to EAP 8.2.
 * @author emmartins
 */
public class EAP7_1ToEAP8_2ServerMigrationProvider implements EAPServerMigrationProvider8_2 {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(
                        serverUpdateBuilders.standaloneConfigurationBuilder()
                                ...
                                .subtask(new EAP7_1ToEAP8_2UpdateInfinispanSubsystem<>())
                                .subtask(new EAP7_1ToEAP8_2UpdateUndertowSubsystem<>())
