...
/**
 * Server migration, from EAP 7.0 to EAP 8.2.
 * @author emmartins
 */
public class EAP7_0ToEAP8_2ServerMigrationProvider implements EAPServerMigrationProvider8_2 {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new EAP7_0ToEAP8_2UpdateInfinispanSubsystem<>())
                        .subtask(new EAP7_0ToEAP8_2UpdateUndertowSubsystem<>())
