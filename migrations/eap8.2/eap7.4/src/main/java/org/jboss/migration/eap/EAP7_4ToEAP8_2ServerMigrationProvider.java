...
import org.jboss.migration.eap.task.subsystem.jgroups.EAP8_2UpdateJGroupsSubsystem;
...
/**
 * Server migration, from EAP 7.4 to EAP 8.2.
 * @author emmartins
 */
public class EAP7_4ToEAP8_2ServerMigrationProvider implements EAPServerMigrationProvider8_2 {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new EAP8_2UpdateJGroupsSubsystem<>())
