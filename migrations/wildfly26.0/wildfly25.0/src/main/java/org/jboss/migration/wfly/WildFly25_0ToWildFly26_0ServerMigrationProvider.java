...
/**
 * Server migration to WFLY 26.0, from WFLY 25.0.
 * @author emmartins
 */
public class WildFly25_0ToWildFly26_0ServerMigrationProvider implements WildFly26_0ServerMigrationProvider {
