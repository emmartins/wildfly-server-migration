...
/**
 * Server migration to WFLY 26.0, from WFLY 23.0.
 * @author emmartins
 */
public class WildFly23_0ToWildFly26_0ServerMigrationProvider implements WildFly26_0ServerMigrationProvider {
