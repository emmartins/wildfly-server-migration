...
/**
 * Server migration to WFLY 26.0, from WFLY 15.0.
 * @author emmartins
 */
public class WildFly15_0ToWildFly26_0ServerMigrationProvider implements WildFly26_0ServerMigrationProvider {
