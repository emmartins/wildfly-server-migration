...
/**
 * Server migration to WFLY 26.0, from WFLY 22.0.
 * @author emmartins
 */
public class WildFly22_0ToWildFly26_0ServerMigrationProvider implements WildFly26_0ServerMigrationProvider {
