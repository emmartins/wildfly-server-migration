...
/**
 * Server migration to WFLY 31.0, from WFLY 25.0.
 * @author emmartins
 */
public class WildFly25_0ToWildFly31_0ServerMigrationProvider implements WildFly31_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly25_0Server> getSourceType() {
