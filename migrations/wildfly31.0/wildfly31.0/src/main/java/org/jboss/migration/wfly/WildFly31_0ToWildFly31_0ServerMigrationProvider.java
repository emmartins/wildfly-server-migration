...
/**
 * Server migration to WFLY 31.0, from WFLY 31.0.
 * @author emmartins
 */
public class WildFly31_0ToWildFly31_0ServerMigrationProvider implements WildFly31_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly31_0Server> getSourceType() {
