...
/**
 * Server migration to WFLY 23.0, from WFLY 19.0.
 * @author emmartins
 */
public class WildFly19_0ToWildFly23_0ServerMigrationProvider implements WildFly23_0ServerMigrationProvider {
