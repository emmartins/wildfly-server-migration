...
/**
 * Server migration to WFLY 23.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly23_0ServerMigrationProvider implements WildFly23_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly23_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly23_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly23_0UpdateJGroupsSubsystem<>())
