...
/**
 * Server migration to WFLY 23.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly23_0ServerMigrationProvider implements WildFly23_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly23_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly23_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly23_0UpdateJGroupsSubsystem<>())
