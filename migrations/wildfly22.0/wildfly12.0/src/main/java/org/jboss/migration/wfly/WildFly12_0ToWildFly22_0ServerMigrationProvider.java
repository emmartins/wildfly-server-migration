...
/**
 * Server migration to WFLY 22.0, from WFLY 12.0.
 * @author emmartins
 */
public class WildFly12_0ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly12_0ToWildFly22_0UpdateUndertowSubsystem<>())
