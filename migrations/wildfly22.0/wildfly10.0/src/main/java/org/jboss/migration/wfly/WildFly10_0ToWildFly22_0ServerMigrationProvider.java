...
/**
 * Server migration to WFLY 22.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly22_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly22_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly22_0UpdateJGroupsSubsystem<>())
