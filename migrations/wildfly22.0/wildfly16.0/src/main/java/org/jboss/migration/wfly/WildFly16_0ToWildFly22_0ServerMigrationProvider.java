...
/**
 * Server migration to WFLY 22.0, from WFLY 16.0.
 * @author emmartins
 */
public class WildFly16_0ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
