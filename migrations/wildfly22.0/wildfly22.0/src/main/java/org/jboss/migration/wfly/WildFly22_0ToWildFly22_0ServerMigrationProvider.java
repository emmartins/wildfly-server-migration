...
/**
 * Server migration to WFLY 22.0, from WFLY 22.0.
 * @author emmartins
 */
public class WildFly22_0ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
