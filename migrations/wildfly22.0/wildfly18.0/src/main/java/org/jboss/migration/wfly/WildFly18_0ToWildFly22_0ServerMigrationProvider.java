...
/**
 * Server migration to WFLY 22.0, from WFLY 18.0.
 * @author emmartins
 */
public class WildFly18_0ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
