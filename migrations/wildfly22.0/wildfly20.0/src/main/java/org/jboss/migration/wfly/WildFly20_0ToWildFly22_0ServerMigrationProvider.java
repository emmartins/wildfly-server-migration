...
/**
 * Server migration to WFLY 22.0, from WFLY 20.0.
 * @author emmartins
 */
public class WildFly20_0ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
