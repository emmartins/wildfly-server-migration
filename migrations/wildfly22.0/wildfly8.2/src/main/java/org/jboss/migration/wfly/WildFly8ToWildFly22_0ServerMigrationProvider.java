...
/**
 * Server migration to WFLY 22.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly22_0ServerMigrationProvider implements WildFly22_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly22_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly22_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly22_0UpdateJGroupsSubsystem<>())
