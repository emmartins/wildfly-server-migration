...
/**
 * Server migration to WFLY 19.0, from WFLY 12.0.
 * @author emmartins
 */
public class WildFly12_0ToWildFly19_0ServerMigrationProvider implements WildFly19_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly12_0ToWildFly19_0UpdateUndertowSubsystem<>())
