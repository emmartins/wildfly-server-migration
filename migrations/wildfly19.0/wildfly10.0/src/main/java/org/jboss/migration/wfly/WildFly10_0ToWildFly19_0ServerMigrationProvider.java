...
/**
 * Server migration to WFLY 19.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly19_0ServerMigrationProvider implements WildFly19_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly19_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly19_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly19_0UpdateJGroupsSubsystem<>())
