...
/**
 * Server migration to WFLY 19.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly19_0ServerMigrationProvider implements WildFly19_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly19_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly19_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly19_0UpdateJGroupsSubsystem<>())
