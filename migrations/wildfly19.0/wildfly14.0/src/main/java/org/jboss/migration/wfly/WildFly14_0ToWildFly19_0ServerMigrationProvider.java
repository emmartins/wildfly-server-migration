...
/**
 * Server migration to WFLY 19.0, from WFLY 14.0.
 * @author emmartins
 */
public class WildFly14_0ToWildFly19_0ServerMigrationProvider implements WildFly19_0ServerMigrationProvider {
