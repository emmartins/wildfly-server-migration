...
/**
 * Server migration to WFLY 19.0, from WFLY 19.0.
 * @author emmartins
 */
public class WildFly19_0ToWildFly19_0ServerMigrationProvider implements WildFly19_0ServerMigrationProvider {
