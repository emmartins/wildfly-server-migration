...
/**
 * Server migration to WFLY 18.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly18_0ServerMigrationProvider implements WildFly18_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly18_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly18_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly18_0UpdateJGroupsSubsystem<>())
