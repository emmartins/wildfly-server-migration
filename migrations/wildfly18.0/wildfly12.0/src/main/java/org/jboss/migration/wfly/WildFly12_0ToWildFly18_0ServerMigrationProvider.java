...
/**
 * Server migration to WFLY 18.0, from WFLY 12.0.
 * @author emmartins
 */
public class WildFly12_0ToWildFly18_0ServerMigrationProvider implements WildFly18_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly12_0ToWildFly18_0UpdateUndertowSubsystem<>())
