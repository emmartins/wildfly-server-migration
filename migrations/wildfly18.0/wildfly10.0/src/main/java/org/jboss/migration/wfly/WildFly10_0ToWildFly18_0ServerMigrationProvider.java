...
/**
 * Server migration to WFLY 18.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly18_0ServerMigrationProvider implements WildFly18_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly18_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly18_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly18_0UpdateJGroupsSubsystem<>())
