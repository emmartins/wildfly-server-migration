...
/**
 * Server migration to WFLY 18.0, from WFLY 10.1.
 * @author emmartins
 */
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly18_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly18_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly18_0UpdateJGroupsSubsystem<>())
