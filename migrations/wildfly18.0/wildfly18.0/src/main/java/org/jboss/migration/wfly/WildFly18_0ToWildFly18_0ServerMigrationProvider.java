...
/**
 * Server migration to WFLY 18.0, from WFLY 17.0.
 * @author emmartins
 */
public class WildFly18_0ToWildFly18_0ServerMigrationProvider implements WildFly18_0ServerMigrationProvider {
