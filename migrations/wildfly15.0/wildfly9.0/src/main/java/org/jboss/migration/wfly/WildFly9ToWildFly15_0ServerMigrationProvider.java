...
/**
 * Server migration to WFLY 15.0, from WFLY 9.
 * @author emmartins
 */
public class WildFly9ToWildFly15_0ServerMigrationProvider implements WildFly15_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly9ToWildFly15_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly9ToWildFly15_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly9ToWildFly15_0UpdateJGroupsSubsystem<>())
