...
/**
 * Server migration to WFLY 15.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly15_0ServerMigrationProvider implements WildFly15_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly15_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly15_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly15_0UpdateJGroupsSubsystem<>())
