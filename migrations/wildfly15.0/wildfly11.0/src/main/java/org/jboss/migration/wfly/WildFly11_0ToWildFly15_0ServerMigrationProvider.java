...
/**
 * Server migration to WFLY 15.0, from WFLY 11.0.
 * @author emmartins
 */
public class WildFly11_0ToWildFly15_0ServerMigrationProvider implements WildFly15_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly11_0ToWildFly15_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly15_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly15_0UpdateJGroupsSubsystem<>())
