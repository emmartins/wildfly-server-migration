...
/**
 * Server migration to WFLY 15.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly15_0ServerMigrationProvider implements WildFly15_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly15_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly15_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly15_0UpdateJGroupsSubsystem<>())
