...
/**
 * Server migration to WFLY 16.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly16_0ServerMigrationProvider implements WildFly16_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly16_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly16_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly16_0UpdateJGroupsSubsystem<>())
