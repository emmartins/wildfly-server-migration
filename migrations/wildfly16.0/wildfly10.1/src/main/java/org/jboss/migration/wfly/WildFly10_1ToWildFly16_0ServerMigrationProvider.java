...
/**
 * Server migration to WFLY 16.0, from WFLY 10.1.
 * @author emmartins
 */
public class WildFly10_1ToWildFly16_0ServerMigrationProvider implements WildFly16_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly16_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly16_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly16_0UpdateJGroupsSubsystem<>())
