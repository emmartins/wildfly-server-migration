...
/**
 * Server migration to WFLY 14.0, from WFLY 10.1.
 * @author emmartins
 */
public class WildFly10_1ToWildFly14_0ServerMigrationProvider implements WildFly14_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly14_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly14_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly14_0UpdateJGroupsSubsystem<>())
