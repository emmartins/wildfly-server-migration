...
/**
 * Server migration to WFLY 20.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly20_0ServerMigrationProvider implements WildFly20_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly20_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly20_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly20_0UpdateJGroupsSubsystem<>())
