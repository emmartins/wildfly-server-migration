...
/**
 * Server migration to WFLY 20.0, from WFLY 9.
 * @author emmartins
 */
public class WildFly9ToWildFly20_0ServerMigrationProvider implements WildFly20_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly9ToWildFly20_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly9ToWildFly20_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly9ToWildFly20_0UpdateJGroupsSubsystem<>())
