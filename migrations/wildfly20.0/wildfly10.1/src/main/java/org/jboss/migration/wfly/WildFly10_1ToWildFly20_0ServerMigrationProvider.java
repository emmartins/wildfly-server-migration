...
import org.jboss.migration.wfly.task.hostexclude.WildFly20_0AddHostExcludes;
...
/**
 * Server migration to WFLY 20.0, from WFLY 10.1.
 * @author emmartins
 */
public class WildFly10_1ToWildFly20_0ServerMigrationProvider implements WildFly20_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly20_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly20_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly20_0UpdateJGroupsSubsystem<>())
                ...
                .domain(serverUpdateBuilders.domainBuilder()
                        .domainConfigurations(serverUpdateBuilders.domainConfigurationBuilder()
                                ...
                                .subtask(new AddMicroprofileConfigSmallryeSubsystem<>())
                                .subtask(new AddMicroprofileOpentracingSmallryeSubsystem<>())
                                .subtask(new WildFly20_0AddHostExcludes<>())
