...
/**
 * Server migration to WFLY 20.0, from WFLY 20.0.
 * @author emmartins
 */
public class WildFly20_0ToWildFly20_0ServerMigrationProvider implements WildFly20_0ServerMigrationProvider {
