...
/**
 * Server migration to WFLY 25.0, from WFLY 10.1.
 * @author emmartins
 */
public class WildFly10_1ToWildFly25_0ServerMigrationProvider implements WildFly25_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly25_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly25_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly25_0UpdateJGroupsSubsystem<>())
