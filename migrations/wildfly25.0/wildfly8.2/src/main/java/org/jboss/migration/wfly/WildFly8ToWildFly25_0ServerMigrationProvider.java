...
/**
 * Server migration to WFLY 25.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly25_0ServerMigrationProvider implements WildFly25_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly25_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly25_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly25_0UpdateJGroupsSubsystem<>())
