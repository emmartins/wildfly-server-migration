...
/**
 * Server migration to WFLY 24.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly24_0ServerMigrationProvider implements WildFly24_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly24_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly24_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly24_0UpdateJGroupsSubsystem<>())
