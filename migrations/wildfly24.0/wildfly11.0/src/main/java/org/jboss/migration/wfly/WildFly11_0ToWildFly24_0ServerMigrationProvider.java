...
/**
 * Server migration to WFLY 24.0, from WFLY 11.0.
 * @author emmartins
 */
public class WildFly11_0ToWildFly24_0ServerMigrationProvider implements WildFly24_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly11_0ToWildFly24_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly24_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly24_0UpdateJGroupsSubsystem<>())
