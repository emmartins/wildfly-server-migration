...
/**
 * Server migration to WFLY 24.0, from WFLY 12.0.
 * @author emmartins
 */
public class WildFly12_0ToWildFly24_0ServerMigrationProvider implements WildFly24_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly12_0ToWildFly24_0UpdateUndertowSubsystem<>())
