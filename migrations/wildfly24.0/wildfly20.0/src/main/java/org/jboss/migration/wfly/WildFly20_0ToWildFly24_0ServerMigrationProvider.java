...
/**
 * Server migration to WFLY 24.0, from WFLY 20.0.
 * @author emmartins
 */
public class WildFly20_0ToWildFly24_0ServerMigrationProvider implements WildFly24_0ServerMigrationProvider {
