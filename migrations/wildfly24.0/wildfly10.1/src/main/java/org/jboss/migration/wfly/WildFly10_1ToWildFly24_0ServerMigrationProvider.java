...
/**
 * Server migration to WFLY 24.0, from WFLY 10.1.
 * @author emmartins
 */
public class WildFly10_1ToWildFly24_0ServerMigrationProvider implements WildFly24_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly24_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly24_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly24_0UpdateJGroupsSubsystem<>())
