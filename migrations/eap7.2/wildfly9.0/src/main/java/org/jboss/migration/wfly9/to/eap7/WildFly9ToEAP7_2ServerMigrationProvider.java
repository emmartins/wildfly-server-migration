...
/**
 * Server migration to EAP 7.2, from WFLY 9.
 * @author emmartins
 */
public class WildFly9ToEAP7_2ServerMigrationProvider implements EAPServerMigrationProvider7_2 {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly9ToEAP7_2UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly9ToEAP7_2UpdateUndertowSubsystem<>())
                        .subtask(new WildFly9ToEAP7_2UpdateJGroupsSubsystem<>())
