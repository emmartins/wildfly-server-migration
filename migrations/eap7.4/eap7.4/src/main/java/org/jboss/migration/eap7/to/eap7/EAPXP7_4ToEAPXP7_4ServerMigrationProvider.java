...
import org.jboss.migration.eap.EAPXPServerMigrationProvider7_4;
...
/**
 * Server migration, from EAP XP 7.4 to EAP XP 7.4.
 * @author emmartins
 */
public class EAPXP7_4ToEAPXP7_4ServerMigrationProvider implements EAPXPServerMigrationProvider7_4 {
    ...
    @Override
    public Class<EAPXPServer7_4> getSourceType() {
        return EAPXPServer7_4.class;
    }
}
