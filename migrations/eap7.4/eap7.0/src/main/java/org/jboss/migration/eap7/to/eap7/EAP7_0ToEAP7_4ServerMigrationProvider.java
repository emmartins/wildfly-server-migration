...
/**
 * Server migration, from EAP 7.0 to EAP 7.4.
 * @author emmartins
 */
public class EAP7_0ToEAP7_4ServerMigrationProvider implements EAPServerMigrationProvider7_4 {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(
                        serverUpdateBuilders.standaloneConfigurationBuilder()
                                ...
                                .subtask(new EAP7_0ToEAP7_4UpdateInfinispanSubsystem<>())
                                .subtask(new EAP7_0ToEAP7_4UpdateUndertowSubsystem<>())
                                .subtask(new EAP7_0ToEAP7_4UpdateJGroupsSubsystem<>())
