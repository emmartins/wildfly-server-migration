...
/**
 * Server migration to WFLY 17.0, from WFLY 10.0.
 * @author emmartins
 */
public class WildFly10_0ToWildFly17_0ServerMigrationProvider implements WildFly17_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_0ToWildFly17_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly17_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_0ToWildFly17_0UpdateJGroupsSubsystem<>())
