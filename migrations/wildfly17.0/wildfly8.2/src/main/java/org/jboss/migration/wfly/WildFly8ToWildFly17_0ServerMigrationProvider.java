...
/**
 * Server migration to WFLY 17.0, from WFLY 8.
 * @author emmartins
 */
public class WildFly8ToWildFly17_0ServerMigrationProvider implements WildFly17_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly8ToWildFly17_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly8ToWildFly17_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly8ToWildFly17_0UpdateJGroupsSubsystem<>())
