...
/**
 * Server migration to WFLY 13.0, from WFLY 11.0.
 * @author emmartins
 */
public class WildFly11_0ToWildFly13_0ServerMigrationProvider implements WildFly13_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly11_0ToWildFly13_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly13_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly11_0ToWildFly13_0UpdateJGroupsSubsystem<>())
