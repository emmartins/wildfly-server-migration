...
/**
 * Server migration to WFLY 13.0, from WFLY 10.1.
 * @author emmartins
 */
public class WildFly10_1ToWildFly13_0ServerMigrationProvider implements WildFly13_0ServerMigrationProvider {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly13_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly13_0UpdateUndertowSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly13_0UpdateJGroupsSubsystem<>())
