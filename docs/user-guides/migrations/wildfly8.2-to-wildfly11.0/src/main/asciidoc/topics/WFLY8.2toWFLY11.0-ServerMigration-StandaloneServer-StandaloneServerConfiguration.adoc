...
// include doc for each task in WildFly8ToWildFly11_0ServerMigrationProvider.java
...
include::WFLY8.2toWFLY11.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::WFLY8.2toWFLY11.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
