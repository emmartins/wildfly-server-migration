...
include::{includesDir}/WFLY8.2toWFLY17.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::{includesDir}/WFLY8.2toWFLY17.0-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::{includesDir}/WFLY8.2toWFLY17.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
