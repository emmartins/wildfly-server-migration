...
:server-target-productName: WildFly 19.0
:server-target-name: WildFly
:server-target-version: 19.0.0.Final
:server-target-baseDir: wildfly-19.0
...
include::{includesDir}/WFLY8.2toWFLY19.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::{includesDir}/WFLY8.2toWFLY19.0-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::{includesDir}/WFLY8.2toWFLY19.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
