...
:server-source-productName: WildFly 19.1
:server-source-name: WildFly
:server-source-version: 19.1.0.Final
:server-source-baseDir: wildfly-19.1
...
include::{includesDir}/WFLY19.0toWFLY27.0-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
