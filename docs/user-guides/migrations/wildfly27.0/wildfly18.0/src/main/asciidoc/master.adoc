...
:server-source-productName: WildFly 18.0
:server-source-name: WildFly
:server-source-version: 18.0.0.Final
:server-source-baseDir: wildfly-18.0
...
include::{includesDir}/WFLY18.0toWFLY27.0-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
