...
:server-source-productName: WildFly 20.0
:server-source-name: WildFly
:server-source-version: 20.0.0.Final
:server-source-baseDir: wildfly-20.0
...
include::{includesDir}/WFLY20.0toWFLY27.0-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
