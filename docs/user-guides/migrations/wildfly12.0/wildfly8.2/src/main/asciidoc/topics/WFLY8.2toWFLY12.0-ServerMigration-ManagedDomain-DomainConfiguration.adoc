...
// include doc for each task in WildFly8ToWildFly12_0ServerMigrationProvider.java
...
include::WFLY8.2toWFLY12.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::WFLY8.2toWFLY12.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
