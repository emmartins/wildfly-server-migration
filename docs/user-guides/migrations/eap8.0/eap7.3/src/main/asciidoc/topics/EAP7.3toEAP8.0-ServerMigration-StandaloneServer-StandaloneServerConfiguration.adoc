...
include::EAP7.3toEAP8.0-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
...
include::EAP7.3toEAP8.0-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::EAP7.3toEAP8.0-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]

include::EAP7.3toEAP8.0-ServerMigration-ServerConfiguration-Subsystem-Migrate-keycloak.adoc[]
