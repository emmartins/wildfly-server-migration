...
:server-source-productName: JBoss EAP 8.0
:server-source-name: JBoss EAP
:server-source-version: 8.0.0.GA
:server-source-baseDir: jboss-eap-8.0
...
include::{includesDir}/EAP8.0toEAP8.0-ServerMigration-StandaloneServer.adoc[]

include::{includesDir}/EAP8.0toEAP8.0-ServerMigration-ManagedDomain.adoc[]
