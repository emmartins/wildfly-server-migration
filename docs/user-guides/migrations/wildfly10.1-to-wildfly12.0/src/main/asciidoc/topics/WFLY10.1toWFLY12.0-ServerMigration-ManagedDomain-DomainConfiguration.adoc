...
// include doc for each task in WildFly10_1ToWildFly12_0ServerMigrationProvider.java
...
include::WFLY10.1toWFLY12.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::WFLY10.1toWFLY12.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
