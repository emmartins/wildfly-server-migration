...
:server-target-productName: WildFly 18.0
:server-target-name: WildFly
:server-target-version: 18.0.0.Final
:server-target-baseDir: wildfly-18.0
...
include::{includesDir}/WFLY8.2toWFLY18.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::{includesDir}/WFLY8.2toWFLY18.0-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::{includesDir}/WFLY8.2toWFLY18.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
