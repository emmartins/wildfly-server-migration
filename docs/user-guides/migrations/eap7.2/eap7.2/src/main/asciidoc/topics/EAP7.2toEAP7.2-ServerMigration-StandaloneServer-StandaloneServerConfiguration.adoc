...
// include doc for each standalone task in EAP7_1ToEAP7_2ServerMigrationProvider.java
...
include::EAP7.2toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::EAP7.2toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::EAP7.2toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
