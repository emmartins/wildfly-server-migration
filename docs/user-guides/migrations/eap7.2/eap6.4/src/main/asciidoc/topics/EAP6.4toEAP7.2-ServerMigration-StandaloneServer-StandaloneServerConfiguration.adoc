...
// include doc for each standalone task in EAP6_4ToEAP7_1ServerMigrationProvider.java

:leveloffset: +1

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-RemoveUnsupportedSubsystems.adoc[]
...
include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-ee.adoc[]

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-ejb3.adoc[]

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-remoting.adoc[]

include::ServerMigration-ServerConfiguration-Subsystem-Update-transactions.adoc[]

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]

include::EAP6.4toEAP7.2-ServerMigration-ServerConfiguration-Subsystem-Update-messaging-activemq.adoc[]
