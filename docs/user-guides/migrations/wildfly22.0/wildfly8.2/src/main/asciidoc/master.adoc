...
:server-target-productName: WildFly 22.0
:server-target-name: WildFly
:server-target-version: 22.0.0.Final
:server-target-baseDir: wildfly-22.0
...
include::{includesDir}/WFLY8.2toWFLY22.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::{includesDir}/WFLY8.2toWFLY22.0-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::{includesDir}/WFLY8.2toWFLY22.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
