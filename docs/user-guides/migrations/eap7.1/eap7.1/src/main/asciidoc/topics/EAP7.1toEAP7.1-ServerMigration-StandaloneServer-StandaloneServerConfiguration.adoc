...
// include doc for each standalone task in EAP7_1ToEAP7_1ServerMigrationProvider.java
...
include::EAP7.1toEAP7.1-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::EAP7.1toEAP7.1-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
