...
include::{includesDir}/ServerMigration-ServerConfiguration-Subsystem-Migrate-jacorb.adoc[]

include::{includesDir}/ServerMigration-ServerConfiguration-Subsystem-Migrate-messaging.adoc[]

include::{includesDir}/WFLY8.2toWFLY26.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::{includesDir}/WFLY8.2toWFLY26.0-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::{includesDir}/WFLY8.2toWFLY26.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
...
include::{includesDir}/ServerMigration-ServerConfiguration-Subsystem-Add-request-controller.adoc[]

include::{includesDir}/ServerMigration-ServerConfiguration-Subsystem-Add-security-manager.adoc[]
...
include::{includesDir}/ServerMigration-ServerConfiguration-Subsystem-Add-jmx.adoc[]
