...
include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]
