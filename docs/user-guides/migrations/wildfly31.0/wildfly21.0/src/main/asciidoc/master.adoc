...
:server-source-productName: WildFly 21.0
:server-source-name: WildFly
:server-source-version: 21.0.0.Final
:server-source-baseDir: wildfly-21.0
...
include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
...
include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]
...
include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-ServerConfiguration-Subsystem-Migrate-keycloak.adoc[]

include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-ServerConfiguration-Subsystem-Migrate-picketlink.adoc[]
...
include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/WFLY21.0toWFLY31.0-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityDomains.adoc[]
