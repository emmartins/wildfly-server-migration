...
include::{includesDir}/WFLY22.0toWFLY31.0-ServerMigration-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/WFLY22.0toWFLY31.0-ServerMigration-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]
