...
include::{includesDir}/WFLY24.0toWFLY31.0-ServerMigration-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/WFLY24.0toWFLY31.0-ServerMigration-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]
