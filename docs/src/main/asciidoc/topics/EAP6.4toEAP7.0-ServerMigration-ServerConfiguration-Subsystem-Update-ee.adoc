...
[source,options="nowrap"]
----
INFO  [ServerMigrationTask#22] (main) Default datasource not found.
0. ExampleDS
1. Unconfigured data source, I want to enter the JNDI name...
Please select Java EE's Default Datasource: (0): 0
INFO  [ServerMigrationTask#22] (main) Java EE Default Datasource configured with JNDI name java:jboss/datasources/ExampleDS.
