...
// include doc for each task in WildFly9ToWildFly11_0ServerMigrationProvider.java
...
include::WFLY9.0toWFLY11.0-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::WFLY9.0toWFLY11.0-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
