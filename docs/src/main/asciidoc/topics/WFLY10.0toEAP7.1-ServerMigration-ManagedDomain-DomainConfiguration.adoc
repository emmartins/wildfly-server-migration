...
include::WFLY10.0toEAP7.1-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::WFLY10.0toEAP7.1-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
