 ...
 * @author emmartins
 */
public class WildFly8Server extends JBossServer<WildFly8Server> {

    public WildFly8Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
