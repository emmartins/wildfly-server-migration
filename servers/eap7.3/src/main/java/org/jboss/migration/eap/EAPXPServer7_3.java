...
/**
 * The JBoss EAP XP 7.3 {@link Server}
 * @author emmartins
 */
public class EAPXPServer7_3 extends WildFlyServer10 {

    private static final WildFlyServerMigrations10 SERVER_MIGRATIONS = new ServiceLoaderWildFlyServerMigrations10<>(ServiceLoader.load(EAPXPServerMigrationProvider7_3.class));

    public static final Extensions EXTENSIONS = Extensions.builder()
            .extensions(EAPServer7_3.EXTENSIONS)
    ...
    public EAPXPServer7_3(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
