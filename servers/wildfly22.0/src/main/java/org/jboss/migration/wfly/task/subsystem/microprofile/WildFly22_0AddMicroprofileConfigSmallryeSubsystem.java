 ...
 * @author emmartins
 */
public class WildFly22_0AddMicroprofileConfigSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly22_0AddMicroprofileConfigSmallryeSubsystem() {
