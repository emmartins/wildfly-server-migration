...
/**
 * The WildFly 22.0 {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFly22_0Server extends WildFlyServer10 {

    public static final JBossServer.Extensions EXTENSIONS = JBossServer.Extensions.builder()
            .extensions(WildFly21_0Server.EXTENSIONS)
            .extension(JBossExtensions.HEALTH)
            .extension(JBossExtensions.METRICS)
            .build();

    private static final WildFlyServerMigrations10 SERVER_MIGRATIONS = new ServiceLoaderWildFlyServerMigrations10<>(ServiceLoader.load(WildFly22_0ServerMigrationProvider.class));

    public WildFly22_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
