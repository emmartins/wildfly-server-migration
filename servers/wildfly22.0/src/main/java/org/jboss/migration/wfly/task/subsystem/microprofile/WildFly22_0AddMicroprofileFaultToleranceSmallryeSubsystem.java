 ...
 * @author emmartins
 */
public class WildFly22_0AddMicroprofileFaultToleranceSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly22_0AddMicroprofileFaultToleranceSmallryeSubsystem() {
