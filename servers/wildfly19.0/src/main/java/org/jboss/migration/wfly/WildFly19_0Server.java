...
/**
 * The WildFly 19.0 {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFly19_0Server extends WildFlyServer10 {
    ...
    public WildFly19_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
