...
/**
 * The WildFly 26.x {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFly26_0ServerProvider extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFly26_0Server(migrationName, productInfo, baseDir, migrationEnvironment);
    }
