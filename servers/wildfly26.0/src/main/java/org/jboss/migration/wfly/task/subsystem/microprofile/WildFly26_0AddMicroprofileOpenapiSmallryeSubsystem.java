 ...
 * @author emmartins
 */
public class WildFly26_0AddMicroprofileOpenapiSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly26_0AddMicroprofileOpenapiSmallryeSubsystem() {
        super(JBossExtensionNames.MICROPROFILE_OPENAPI_SMALLRYE, new SubtaskBuilder<>());
    ...
    static class SubtaskBuilder<S> extends AddSubsystemResourceSubtaskBuilder<S> {
        SubtaskBuilder() {
            super(JBossSubsystemNames.MICROPROFILE_OPENAPI_SMALLRYE);
