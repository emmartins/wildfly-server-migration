...
package org.jboss.migration.wfly.task.subsystem.metrics;
 ...
 * @author emmartins
 */
public class WildFly26_0AddMetricsSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly26_0AddMetricsSubsystem() {
    ...
    static class SubtaskBuilder<S> extends AddSubsystemResourceSubtaskBuilder<S> {
        ...
        protected void addConfiguration(ManageableResourceBuildParameters<S, SubsystemResource.Parent> params, TaskContext taskContext) {
            ...
            op.get("prefix").set(new ValueExpression("${wildfly.metrics.prefix:wildfly}"));
