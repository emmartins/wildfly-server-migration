...
public class LegacySecurityConfigurations {
    ...
    public LegacySecurityConfiguration getSecurityConfiguration(Path serverConfigurationPath) {

        return securityConfigurations.get(serverConfigurationPath.toString());
