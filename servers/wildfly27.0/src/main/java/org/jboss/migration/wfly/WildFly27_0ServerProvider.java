...
/**
 * The WildFly 27.x {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFly27_0ServerProvider extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFly27_0Server(migrationName, productInfo, baseDir, migrationEnvironment);
    }
