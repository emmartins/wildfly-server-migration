...
/**
 * The WildFly 14.0 {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFly14_0ServerProvider extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFly14_0Server(migrationName, productInfo, baseDir, migrationEnvironment);
    }
