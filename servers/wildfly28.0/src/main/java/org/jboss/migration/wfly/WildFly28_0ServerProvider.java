...
/**
 * The WildFly 28.x {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFly28_0ServerProvider extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFly28_0Server(migrationName, productInfo, baseDir, migrationEnvironment);
    }
