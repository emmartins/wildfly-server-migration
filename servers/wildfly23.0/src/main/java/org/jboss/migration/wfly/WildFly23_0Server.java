...
/**
 * The WildFly 23.0 {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFly23_0Server extends WildFlyServer10 {

    public static final JBossServer.Extensions EXTENSIONS = JBossServer.Extensions.builder()
            .extensions(WildFly22_0Server.EXTENSIONS)
    ...
    private static final WildFlyServerMigrations10 SERVER_MIGRATIONS = new ServiceLoaderWildFlyServerMigrations10<>(ServiceLoader.load(WildFly23_0ServerMigrationProvider.class));

    public WildFly23_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
