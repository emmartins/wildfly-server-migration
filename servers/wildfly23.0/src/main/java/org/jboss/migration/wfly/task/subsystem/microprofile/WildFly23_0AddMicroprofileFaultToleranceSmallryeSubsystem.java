 ...
 * @author emmartins
 */
public class WildFly23_0AddMicroprofileFaultToleranceSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly23_0AddMicroprofileFaultToleranceSmallryeSubsystem() {
