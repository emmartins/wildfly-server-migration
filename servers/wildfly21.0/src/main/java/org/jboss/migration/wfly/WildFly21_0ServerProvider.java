...
/**
 * The WildFly 21.0 {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFly21_0ServerProvider extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFly21_0Server(migrationName, productInfo, baseDir, migrationEnvironment);
    }
