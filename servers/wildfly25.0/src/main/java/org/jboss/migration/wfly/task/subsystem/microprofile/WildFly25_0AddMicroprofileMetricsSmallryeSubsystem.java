 ...
 * @author emmartins
 */
public class WildFly25_0AddMicroprofileMetricsSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly25_0AddMicroprofileMetricsSmallryeSubsystem() {
        super(JBossExtensionNames.MICROPROFILE_METRICS_SMALLRYE, new SubtaskBuilder<>());
    ...
    static class SubtaskBuilder<S> extends AddSubsystemResourceSubtaskBuilder<S> {
        SubtaskBuilder() {
            super(JBossSubsystemNames.MICROPROFILE_METRICS_SMALLRYE);
