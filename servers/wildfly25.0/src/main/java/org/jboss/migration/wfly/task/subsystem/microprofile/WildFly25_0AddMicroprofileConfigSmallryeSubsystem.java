 ...
 * @author emmartins
 */
public class WildFly25_0AddMicroprofileConfigSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly25_0AddMicroprofileConfigSmallryeSubsystem() {
        super(JBossExtensionNames.MICROPROFILE_CONFIG_SMALLRYE, new SubtaskBuilder<>());
    ...
    static class SubtaskBuilder<S> extends AddSubsystemResourceSubtaskBuilder<S> {
        SubtaskBuilder() {
            super(JBossSubsystemNames.MICROPROFILE_CONFIG_SMALLRYE);
