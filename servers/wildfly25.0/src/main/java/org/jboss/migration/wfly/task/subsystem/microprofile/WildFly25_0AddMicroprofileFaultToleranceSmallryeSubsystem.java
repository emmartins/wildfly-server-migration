 ...
 * @author emmartins
 */
public class WildFly25_0AddMicroprofileFaultToleranceSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly25_0AddMicroprofileFaultToleranceSmallryeSubsystem() {
        super(JBossExtensionNames.MICROPROFILE_FAULT_TOLERANCE_SMALLRYE, new SubtaskBuilder<>());
    ...
    static class SubtaskBuilder<S> extends AddSubsystemResourceSubtaskBuilder<S> {
        SubtaskBuilder() {
            super(JBossSubsystemNames.MICROPROFILE_FAULT_TOLERANCE_SMALLRYE);
