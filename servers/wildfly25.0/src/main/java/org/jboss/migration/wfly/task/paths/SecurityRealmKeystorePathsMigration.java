...
/**
 * Migration of keystore files referenced by Security Realm XML configurations.
 * @author emmartins
 */
public class SecurityRealmKeystorePathsMigration extends ResolvablePathsMigration {
    ...
    public static class Factory implements XmlConfigurationMigration.ComponentFactory {
        ...
        public XmlConfigurationMigration.Component newComponent() {
            return new SecurityRealmKeystorePathsMigration();
        }
    }
