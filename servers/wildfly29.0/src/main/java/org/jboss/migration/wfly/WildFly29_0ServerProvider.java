...
/**
 * The WildFly 29.x {@link org.jboss.migration.core.ServerProvider}.
 *  @author emmartins
 */
public class WildFly29_0ServerProvider extends WildFlyFullServerProvider10_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new WildFly29_0Server(migrationName, productInfo, baseDir, migrationEnvironment);
    }
