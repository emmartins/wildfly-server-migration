 ...
 * @author emmartins
 */
public class WildFly24_0AddMicroprofileFaultToleranceSmallryeSubsystem<S> extends AddSubsystemResources<S> {

    public WildFly24_0AddMicroprofileFaultToleranceSmallryeSubsystem() {
