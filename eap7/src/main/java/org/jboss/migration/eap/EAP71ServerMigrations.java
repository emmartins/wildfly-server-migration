 ...
 * @author emmartins
 */
public class EAP71ServerMigrations {

    private static final ServiceLoader<EAP71ServerMigrationProvider> SERVICE_LOADER = ServiceLoader.load(EAP71ServerMigrationProvider.class);

    private EAP71ServerMigrations() {
    }
    ...
    static WildFly10ServerMigration getMigrationFrom(Server sourceServer) {
        ...
        for (EAP71ServerMigrationProvider serverMigrationProvider : SERVICE_LOADER) {
