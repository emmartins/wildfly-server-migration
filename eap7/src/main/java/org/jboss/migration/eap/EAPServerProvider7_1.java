...
/**
 * The EAP 7.1 {@link org.jboss.migration.core.ServerProvider}.
 * @author emmartins
 */
public class EAPServerProvider7_1 extends EAPServerProvider7_0 {
    ...
    protected Server constructServer(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
        return new EAPServer7_1(migrationName, productInfo, baseDir, migrationEnvironment);
    }
