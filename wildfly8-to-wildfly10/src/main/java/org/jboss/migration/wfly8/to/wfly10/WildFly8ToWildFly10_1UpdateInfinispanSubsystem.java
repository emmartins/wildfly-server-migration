 ...
 * @author emmartins
 */
public class WildFly8ToWildFly10_1UpdateInfinispanSubsystem<S> extends UpdateSubsystemConfigurations<S> {
    public WildFly8ToWildFly10_1UpdateInfinispanSubsystem() {
