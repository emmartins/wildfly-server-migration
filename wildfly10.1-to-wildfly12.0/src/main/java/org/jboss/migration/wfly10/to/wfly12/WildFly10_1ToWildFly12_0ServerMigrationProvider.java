 ...
 * @author emmartins
 */
public class WildFly10_1ToWildFly12_0ServerMigrationProvider implements WildFlyFullServerMigrationProvider12_0 {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new WildFly10_1ToWildFly12_0UpdateInfinispanSubsystem<>())
                        .subtask(new WildFly10_1ToWildFly12_0UpdateUndertowSubsystem<>())
