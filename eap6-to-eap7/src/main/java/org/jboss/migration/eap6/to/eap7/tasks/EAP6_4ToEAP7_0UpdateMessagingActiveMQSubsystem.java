 ...
 * @author emmartins
 */
public class EAP6_4ToEAP7_0UpdateMessagingActiveMQSubsystem<S> extends UpdateSubsystemConfigurations<S> {
    public EAP6_4ToEAP7_0UpdateMessagingActiveMQSubsystem() {
        super(SubsystemNames.MESSAGING_ACTIVEMQ,
